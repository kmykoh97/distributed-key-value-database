...
public class RPCController {
    ...
    public ResponseEntity<String> saveData(HttpServletRequest request,
        ...
        List<String> liveNodes = Clusters.getClusterInfo().getSlaveNodes();
    ...
    private boolean checkheartbeat(String nodeToSend) {
        ...
        HttpStatus returnstatus = restTemplate.exchange(requestUrl, HttpMethod.GET, entity, String.class).getStatusCode();
