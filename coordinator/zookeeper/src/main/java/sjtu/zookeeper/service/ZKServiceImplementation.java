package sjtu.zookeeper.service;
...
import sjtu.zookeeper.util.StringSerializer;
...
@Slf4j
public class ZKServiceImplementation implements ZKService {

    private ZkClient zkClient;

    public ZKServiceImplementation(String zkServers) {
